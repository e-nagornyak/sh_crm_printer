...
contextBridge.exposeInMainWorld("cacheRegisterAPI", {
  sendToCacheRegister: (commands) =>
    ipcRenderer.invoke("send-to-cache-register", commands),
})

contextBridge.exposeInMainWorld("printerAPI", {
  getPrinters: () => ipcRenderer.invoke("get-printers"),
  getPrintersNew: () => ipcRenderer.invoke("get-printers-new"),
  downloadAndPrintPDF: (pdfUrl, printerLabel) =>
    ipcRenderer.invoke("download-and-print-pdf", pdfUrl, printerLabel),
})
...
contextBridge.exposeInMainWorld(ContextBridgeAPI.loggingAPI.name, {
  ...
  clearLogs: () =>
    ipcRenderer.invoke(ContextBridgeAPI.loggingAPI.keys.CLEAR_LOGS),
})
